...
import { getAllReviews } from '../../lib/auth'
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <Metric label="Total reviews" value={summary.total} />
        <Metric label="Average rating" tone="amber" value={formatRating(summary.averageRating)} />
      </div>
      ...
      <div className="mt-6">
        <label className="relative block">
          ...
          <input
            ...
            placeholder="Search by customer, appointment, comment, or rating..."
            value={query}
